...
# See: https://www.coursera.org/learn/algorithms-part1/lecture/ewcSx/symbol-table-applications-sets-optional
#
...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        ...
        """
        if val not in self._values_hm:
            self._values.append(val)
            self._values_hm.add(val)
            return True
        return False
    ...
    def remove(self, val: int) -> bool:
        ...
        specified element.
        """
        exists = val in self._values_hm
        if exists:
            self._values_hm.remove(val)
